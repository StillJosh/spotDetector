...
class DeepSpotNet3D(nn.Module):
    """
    DeepSpot model for 3D image segmentation.
    ...
    def __init__(
        ...
        # Output layer
        self.output_layer = nn.Conv3d(32, 1, kernel_size=1, padding=0)
...
img = tf.imread('/Volumes/Segate_Ext/tuna/FI101/FI101_rc/C5_MCF-7_FH160_T1T2 Cyan_T3 Red_50%_GAPDH_4_15.tif')
img = img[10:34,0, :128, :128]
img_tensor = torch.tensor(img).unsqueeze(0).unsqueeze(0).float().to('cpu')
